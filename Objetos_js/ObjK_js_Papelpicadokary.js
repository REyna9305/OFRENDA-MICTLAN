...
var txtimg = new THREE.MeshLambertMaterial({
    color: 0x9E3AB0 , side:THREE.DoubleSide
...
//PPGrup
    var PPGrup = new THREE.Group();
    PPGrup.add(mesh01,mesh06,mesh07,mesh08,mesh09,mesh10,mesh11,mesh12,mesh13,petalo,petalo02,petalo03,petalo04,Volane,VOlane02,VOlane03);
    
    PPGrup.position.set(x,y,z);
         return PPGrup;
